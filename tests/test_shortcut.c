...
test_shortcut_full_table_registered(void) {
   static const char *ACTIONS[] = {
      ...
      "win.open",      "win.open-external", "win.quit",         "win.trash",
      "win.delete",    "win.undo",          "win.toggle-view",  "win.mark",
      "win.mark-all",  "win.mark-range",    "win.shortcuts",    "win.zoom-in",
      "win.zoom-out",  "win.fullscreen",    "win.slideshow",    "win.info",
      "win.back",      "win.enhance",       "win.enhance-save", "win.enhance-1",
      "win.enhance-2", "win.enhance-3",     "win.enhance-4",    "win.enhance-5",
   ...
   g_assert_cmpint(g_list_model_get_n_items(G_LIST_MODEL(p_sc)), ==, 36);
   g_object_unref(p_sc);
   g_object_unref(p_win);
   drain_main(200);
}
